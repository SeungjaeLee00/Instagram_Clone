...
const Signup = () => {
    ...
    <div className = "signup-page">
      <div className = "signup-content">
        ...
        {/* 인스타 로고 */}
        <img className = "signup-instalogo" 
            alt = "Instagram"
            src = {instalogo}
        ...
        <div className = "signup-inputWrap">
            {/* 이메일 */}
            <input className = "signup-input" placeholder={"이메일 주소"}
              value = {email}
            ...
            {/* 비밀번호 */}
            <input className = "signup-input" placeholder={"비밀번호"}
              value = {password}
            ...
            {/* 성명 */}
            <input className = "signup-input" placeholder={"성명"}
              value = {name}
              onChange = {handleName}
              type = "text"
            />
            ...
            <button className = "signup-submitButton" 
                onClick = {onclickConfirmButton} 
                disabled={NotAllow}> 가입
            </button>
        </div>
      </div>
